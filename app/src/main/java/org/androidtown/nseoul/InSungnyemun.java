...
public class InSungnyemun extends Activity {

    //백버튼
    private BackPressCloseHandler backPressCloseHandler;

    //소개 페이지
    LinearLayout sungnyemunPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insungnyemun);
        ...
        //소개 페이지
        sungnyemunPage = (LinearLayout) findViewById(R.id.sungnyemunPage);
        sungnyemunPage.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
    ...
    public void btnBusClicked(View v) {
        ...
        if(text.compareTo(text3) == 0) {
            Intent intent = (new Intent(InSungnyemun.this, Citytour1.class));
            intent.putExtra("type", "3");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InSungnyemun.this.finish();
        }
        else if(text.compareTo(text4) == 0) {
            Intent intent = (new Intent(InSungnyemun.this, Citytour2.class));
            ...
            Intent intent = (new Intent(InSungnyemun.this, Citytour3.class));
    ...
    public void Back(){
        ...
        {
            Intent intent = (new Intent(InSungnyemun.this, TypicalActivity.class));
            startActivity(intent);
        ...
        {
            Intent intent = (new Intent(InSungnyemun.this, MenunorthActivity.class));
            startActivity(intent);
        ...
        else if(text.compareTo(text5) == 0)
        {
            ...
            Intent intent = (new Intent(InSungnyemun.this, MenuActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InSungnyemun.this.finish();
        }
    ...
    public void btnweatherClicked(View v) {
        ...
        if (isNetWork() == true) {
            ...
            if(text.compareTo(text1) == 0)
            {
                Intent intent = (new Intent(InSungnyemun.this, InSungnyemunnal.class));
    ...
    public void OpenMap(){
        ...
        if(text.compareTo(text1) == 0)
        {
            Intent intent = (new Intent(InSungnyemun.this, InSungnyemunmap.class));
            intent.putExtra("type", "1");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InSungnyemun.this.finish();
    ...
    public void btnengClicked(View v) {
        imageview3.setImageDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.sungnyemuninfo2)));
        imageview4.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.sungnyemunsub2)));
    }
