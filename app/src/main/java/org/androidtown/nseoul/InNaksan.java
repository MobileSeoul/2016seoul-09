...
public class InNaksan extends Activity {

    //백버튼
    private BackPressCloseHandler backPressCloseHandler;

    //소개 페이지
    LinearLayout naksanPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_innaksan);
        ...
        //소개 페이지
        naksanPage = (LinearLayout) findViewById(R.id.naksanPage);
        naksanPage.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
    ...
    public void Back(){
        ...
        {
            Intent intent = (new Intent(InNaksan.this, SceneryActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.out_to_left);
            InNaksan.this.finish();
        }
        else if(text.compareTo(text2) == 0)
        {
            Intent intent = (new Intent(InNaksan.this, MenunorthActivity.class));
            startActivity(intent);
            ...
            Intent intent = (new Intent(InNaksan.this, MenuActivity.class));
            startActivity(intent);
    ...
    public void btnweatherClicked(View v) {
        ...
        if (isNetWork() == true) {
            ...
            if(text.compareTo(text1) == 0)
            {
                Intent intent = (new Intent(InNaksan.this, InNaksannal.class));
    ...
    public void OpenMap(){
        ...
        if(text.compareTo(text1) == 0)
        {
            Intent intent = (new Intent(InNaksan.this, InNaksanmap.class));
            intent.putExtra("type", "1");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InNaksan.this.finish();
    ...
    public void btnengClicked(View v) {
        imageview3.setImageDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.naksaninfo2)));
        imageview4.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.naksansub2)));
    }
