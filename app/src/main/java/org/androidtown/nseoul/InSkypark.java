...
public class InSkypark extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inskypark);
        ...
        //소개 페이지
        skyparkPage = (LinearLayout) findViewById(R.id.skyparkPage);
    ...
    public void Back(){
        ...
        {
            Intent intent = (new Intent(InSkypark.this, SceneryActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.out_to_right);
            InSkypark.this.finish();
        }
        else if(text.compareTo(text2) == 0)
        {
            Intent intent = (new Intent(InSkypark.this, MenuwestActivity.class));
            startActivity(intent);
            ...
            Intent intent = (new Intent(InSkypark.this, MenuActivity.class));
            startActivity(intent);
    ...
    public void btnweatherClicked(View v) {
        ...
        if (isNetWork() == true) {
            ...
            if(text.compareTo(text1) == 0)
            {
                Intent intent = (new Intent(InSkypark.this, InSkyparknal.class));
    ...
    public void OpenMap(){
        ...
        if(text.compareTo(text1) == 0)
        {
            Intent intent = (new Intent(InSkypark.this, InSkyparkmap.class));
            intent.putExtra("type", "1");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InSkypark.this.finish();
    ...
    public void btnengClicked(View v) {
        imageview3.setImageDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.skyparkinfo2)));
        imageview4.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.skyparksub2)));
    }
