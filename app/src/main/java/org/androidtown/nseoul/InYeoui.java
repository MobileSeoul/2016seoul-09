...
public class InYeoui extends Activity {

    //백버튼
    private BackPressCloseHandler backPressCloseHandler;

    //소개 페이지
    LinearLayout yeouiPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inyeoui);
        ...
        //소개 페이지
        yeouiPage = (LinearLayout) findViewById(R.id.yeouiPage);
        yeouiPage.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
    ...
    public void btnBusClicked(View v) {
        Intent intent = (new Intent(InYeoui.this, Citytour1.class));
    ...
    public void Back(){
        ...
        {
            Intent intent = (new Intent(InYeoui.this, TypicalActivity.class));
            startActivity(intent);
        ...
        {
            Intent intent = (new Intent(InYeoui.this, MenuwestActivity.class));
            startActivity(intent);
        ...
        else if(text.compareTo(text3) == 0)
        {
            ...
            Intent intent = (new Intent(InYeoui.this, MenuActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InYeoui.this.finish();
        }
    ...
    public void btnweatherClicked(View v) {
        ...
        if (isNetWork() == true) {
            ...
            if(text.compareTo(text1) == 0)
            {
                Intent intent = (new Intent(InYeoui.this, InYeouinal.class));
    ...
    public void OpenMap(){
        ...
        if(text.compareTo(text1) == 0)
        {
            Intent intent = (new Intent(InYeoui.this, InYeouimap.class));
            intent.putExtra("type", "1");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InYeoui.this.finish();
    ...
    public void btnengClicked(View v) {
        imageview3.setImageDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.yeouiinfo2)));
        imageview4.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.yeouisub2)));
    }
