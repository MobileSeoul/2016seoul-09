...
public class InChihyunjung extends Activity {

    //백버튼
    private BackPressCloseHandler backPressCloseHandler;

    //소개 페이지
    LinearLayout chihyunjungPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inchihyunjung);
        ...
        //소개 페이지
        chihyunjungPage = (LinearLayout) findViewById(R.id.chihyunjungPage);
        chihyunjungPage.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
    ...
    public void Back(){
        ...
        {
            Intent intent = (new Intent(InChihyunjung.this, HiddenActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.out_to_left);
            InChihyunjung.this.finish();
        }
        else if(text.compareTo(text2) == 0)
        {
            Intent intent = (new Intent(InChihyunjung.this, MenuwestActivity.class));
            startActivity(intent);
            ...
            Intent intent = (new Intent(InChihyunjung.this, MenuActivity.class));
            startActivity(intent);
    ...
    public void btnweatherClicked(View v) {
        ...
        if (isNetWork() == true) {
            ...
            if(text.compareTo(text1) == 0)
            {
                Intent intent = (new Intent(InChihyunjung.this, InChihyunjungnal.class));
    ...
    public void OpenMap(){
        ...
        if(text.compareTo(text1) == 0)
        {
            Intent intent = (new Intent(InChihyunjung.this, InChihyunjungmap.class));
            intent.putExtra("type", "1");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InChihyunjung.this.finish();
    ...
    public void btnengClicked(View v) {
        imageview3.setImageDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.chihyunjunginfo2)));
        imageview4.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.chihyunjungsub2)));
    }
