...
public class InNamsan extends Activity {

    //백버튼
    private BackPressCloseHandler backPressCloseHandler;

    //소개 페이지
    LinearLayout namsanPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_innamsan);
        ...
        //소개 페이지
        namsanPage = (LinearLayout) findViewById(R.id.namsanPage);
        namsanPage.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
    ...
    public void btnBusClicked(View v) {
        ...
        {
            Intent intent = (new Intent(InNamsan.this, Citytour2.class));
            intent.putExtra("type", "4");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InNamsan.this.finish();
        }
        else {
            Intent intent = (new Intent(InNamsan.this, Citytour1.class));
    ...
    public void Back(){
        ...
        {
            Intent intent = (new Intent(InNamsan.this, SceneryActivity.class));
            startActivity(intent);
        ...
        {
            Intent intent = (new Intent(InNamsan.this, MenunorthActivity.class));
            startActivity(intent);
        ...
        else if(text.compareTo(text4) == 0)
        {
            ...
            Intent intent = (new Intent(InNamsan.this, MenuActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InNamsan.this.finish();
        }
    ...
    public void btnweatherClicked(View v) {
        ...
        if (isNetWork() == true) {
            ...
            if(text.compareTo(text1) == 0)
            {
                Intent intent = (new Intent(InNamsan.this, InNamsannal.class));
    ...
    public void OpenMap(){
        ...
        if(text.compareTo(text1) == 0)
        {
            Intent intent = (new Intent(InNamsan.this, InNamsanmap.class));
            intent.putExtra("type", "1");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InNamsan.this.finish();
    ...
    public void btnengClicked(View v) {
        imageview3.setImageDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.namsaninfo2)));
        imageview4.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.namsansub2)));
    }
