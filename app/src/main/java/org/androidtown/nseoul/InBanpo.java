...
public class InBanpo extends Activity {

    //백버튼
    private BackPressCloseHandler backPressCloseHandler;

    //소개 페이지
    LinearLayout banpoPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inbanpo);
        ...
        //소개 페이지
        banpoPage = (LinearLayout) findViewById(R.id.banpoPage);
        banpoPage.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
    ...
    public void btnBusClicked(View v) {
        Intent intent = (new Intent(InBanpo.this, Citytour2.class));
    ...
    public void Back(){
        ...
        {
            Intent intent = (new Intent(InBanpo.this, TypicalActivity.class));
            startActivity(intent);
        ...
        {
            Intent intent = (new Intent(InBanpo.this, MenusouthActivity.class));
            startActivity(intent);
        ...
        else if(text.compareTo(text4) == 0)
        {
            ...
            Intent intent = (new Intent(InBanpo.this, MenuActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InBanpo.this.finish();
        }
    ...
    public void btnweatherClicked(View v) {
        ...
        if (isNetWork() == true) {
            ...
            if(text.compareTo(text1) == 0)
            {
                Intent intent = (new Intent(InBanpo.this, InBanponal.class));
    ...
    public void OpenMap(){
        ...
        if(text.compareTo(text1) == 0)
        {
            Intent intent = (new Intent(InBanpo.this, InBanpomap.class));
            intent.putExtra("type", "1");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InBanpo.this.finish();
    ...
    public void btnengClicked(View v) {
        imageview3.setImageDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.banpoinfo2)));
        imageview4.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.banposub2)));
    }
