...
public class InDeoksugung extends Activity {

    //백버튼
    private BackPressCloseHandler backPressCloseHandler;

    //소개 페이지
    LinearLayout deoksugungPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indeoksugung);
        ...
        //소개 페이지
        deoksugungPage = (LinearLayout) findViewById(R.id.deoksugungPage);
        deoksugungPage.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
    ...
    public void Back(){
        ...
        {
            Intent intent = (new Intent(InDeoksugung.this, PalaceActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.out_to_right);
            InDeoksugung.this.finish();
        }
        else if(text.compareTo(text2) == 0)
        {
            Intent intent = (new Intent(InDeoksugung.this, MenunorthActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.out_to_right);
            InDeoksugung.this.finish();
        }
            ...
            Intent intent = (new Intent(InDeoksugung.this, MenuActivity.class));
            startActivity(intent);
    ...
    public void btnweatherClicked(View v) {
        ...
        if (isNetWork() == true) {
            ...
            if(text.compareTo(text1) == 0)
            {
                Intent intent = (new Intent(InDeoksugung.this, InDeoksugungnal.class));
    ...
    public void OpenMap(){
        ...
        if(text.compareTo(text1) == 0)
        {
            Intent intent = (new Intent(InDeoksugung.this, InDeoksugungmap.class));
            intent.putExtra("type", "1");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InDeoksugung.this.finish();
    ...
    public void btnengClicked(View v) {
        imageview3.setImageDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.deoksugunginfo2)));
        imageview4.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.deoksugungsub2)));
    }
