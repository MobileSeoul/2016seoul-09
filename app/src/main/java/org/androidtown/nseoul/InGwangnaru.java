...
public class InGwangnaru extends Activity {

    //백버튼
    private BackPressCloseHandler backPressCloseHandler;

    //소개 페이지
    LinearLayout gwangnaruPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingwangnaru);
        ...
        //소개 페이지
        gwangnaruPage = (LinearLayout) findViewById(R.id.gwangnaruPage);
        gwangnaruPage.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
    ...
    public void Back(){
        ...
        {
            Intent intent = (new Intent(InGwangnaru.this, HiddenActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.out_to_left);
            InGwangnaru.this.finish();
        }
        else if(text.compareTo(text2) == 0)
        {
            Intent intent = (new Intent(InGwangnaru.this, MenueastActivity.class));
            startActivity(intent);
            ...
            Intent intent = (new Intent(InGwangnaru.this, MenuActivity.class));
            startActivity(intent);
    ...
    public void btnweatherClicked(View v) {
        ...
        if (isNetWork() == true) {
            ...
            if(text.compareTo(text1) == 0)
            {
                Intent intent = (new Intent(InGwangnaru.this, InGwangnarunal.class));
    ...
    public void OpenMap(){
        ...
        if(text.compareTo(text1) == 0)
        {
            Intent intent = (new Intent(InGwangnaru.this, InGwangnarumap.class));
            intent.putExtra("type", "1");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InGwangnaru.this.finish();
    ...
    public void btnengClicked(View v) {
        imageview3.setImageDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.gwangnaruinfo2)));
        imageview4.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.gwangnarusub2)));
    }
