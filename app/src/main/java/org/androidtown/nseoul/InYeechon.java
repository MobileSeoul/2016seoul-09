...
public class InYeechon extends Activity {

    //백버튼
    private BackPressCloseHandler backPressCloseHandler;

    //소개 페이지
    LinearLayout yeechonPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inyeechon);
        ...
        //소개 페이지
        yeechonPage = (LinearLayout) findViewById(R.id.yeechonPage);
        yeechonPage.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
    ...
    public void btnBusClicked(View v) {
        ...
        {
            Intent intent = (new Intent(InYeechon.this, Citytour2.class));
            intent.putExtra("type", "4");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InYeechon.this.finish();
        }
        else {
            Intent intent = (new Intent(InYeechon.this, Citytour1.class));
    ...
    public void Back(){
        ...
        {
            Intent intent = (new Intent(InYeechon.this, HiddenActivity.class));
            startActivity(intent);
        ...
        {
            Intent intent = (new Intent(InYeechon.this, MenunorthActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.out_to_right);
            InYeechon.this.finish();
        }
        ...
        else if(text.compareTo(text4) == 0)
        {
            ...
            Intent intent = (new Intent(InYeechon.this, MenuActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InYeechon.this.finish();
        }
    ...
    public void btnweatherClicked(View v) {
        ...
        if (isNetWork() == true) {
            ...
            if(text.compareTo(text1) == 0)
            {
                Intent intent = (new Intent(InYeechon.this, InYeechonnal.class));
    ...
    public void OpenMap(){
        ...
        if(text.compareTo(text1) == 0)
        {
            Intent intent = (new Intent(InYeechon.this, InYeechonmap.class));
            intent.putExtra("type", "1");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InYeechon.this.finish();
    ...
    public void btnengClicked(View v) {
        imageview3.setImageDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.yeechoninfo2)));
        imageview4.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.yeechonsub2)));
    }
