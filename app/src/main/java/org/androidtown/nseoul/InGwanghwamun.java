...
public class InGwanghwamun extends Activity {

    //백버튼
    private BackPressCloseHandler backPressCloseHandler;

    //소개 페이지
    LinearLayout gwanghwamunPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingwanghwamun);
        ...
        //소개 페이지
        gwanghwamunPage = (LinearLayout) findViewById(R.id.gwanghwamunPage);
        gwanghwamunPage.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
    ...
    public void btnBusClicked(View v) {
        ...
        {
            Intent intent = (new Intent(InGwanghwamun.this, Citytour1.class));
            intent.putExtra("type", "3");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InGwanghwamun.this.finish();
        }
        else if(text.compareTo(text4) == 0)
        {
            Intent intent = (new Intent(InGwanghwamun.this, Citytour2.class));
        ...
        {
            Intent intent = (new Intent(InGwanghwamun.this, Citytour3.class));
    ...
    public void Back(){
        ...
        {
            Intent intent = (new Intent(InGwanghwamun.this, TypicalActivity.class));
            startActivity(intent);
        ...
        {
            Intent intent = (new Intent(InGwanghwamun.this, MenunorthActivity.class));
            startActivity(intent);
        ...
        else if(text.compareTo(text5) == 0)
        {
            ...
            Intent intent = (new Intent(InGwanghwamun.this, MenuActivity.class));
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InGwanghwamun.this.finish();
        }
    ...
    public void btnweatherClicked(View v) {
        ...
        if (isNetWork() == true) {
            ...
            if(text.compareTo(text1) == 0)
            {
                Intent intent = (new Intent(InGwanghwamun.this, InGwanghwamunnal.class));
    ...
    public void OpenMap(){
        ...
        if(text.compareTo(text1) == 0)
        {
            Intent intent = (new Intent(InGwanghwamun.this, InGwanghwamunmap.class));
            intent.putExtra("type", "1");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InGwanghwamun.this.finish();
    ...
    public void btnengClicked(View v) {
        imageview3.setImageDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.gwanghwamuninfo2)));
        imageview4.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
                (getResources(), R.drawable.gwanghwamunsub2)));
    }
