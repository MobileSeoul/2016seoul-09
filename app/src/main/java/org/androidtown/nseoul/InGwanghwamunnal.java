...
public class InGwanghwamunnal extends Activity {
    ...
    //소개 페이지
    LinearLayout gwanghwamunnalPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingwanghwamunnal);
        ...
        //소개 페이지
        gwanghwamunnalPage = (LinearLayout) findViewById(R.id.gwanghwamunnalPage);
        gwanghwamunnalPage.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource
    ...
    public void Back(){
        ...
        {
            Intent intent = (new Intent(InGwanghwamunnal.this, InGwanghwamun.class));
            intent.putExtra("type", "1");
            startActivity(intent);
            overridePendingTransition(R.anim.fade, R.anim.hold);
            InGwanghwamunnal.this.finish();
        }
